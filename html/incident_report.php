            ...
            <div class="container-fluid">
                <div class="row bg-title" style="margin-top: 10px">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Incident Reports</h4> </div>
                                    ...
                                    <div class="white-box">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $sql = mysqli_query($db, "SELECT * FROM tblreports ORDER BY `id` DESC");
                                                        while ($res = mysqli_fetch_array($sql)) {
                                                            ...
                                                            <tr>
                                                                <td><?= $res['id'] ?></td>
                                                                <td><img class="img-responsive" alt="No Image" style="height: 150px;width: 150px;padding: 10px" src="<?= 'data:image/jpeg;base64,'.base64_encode($data).'' ?>"></td>
                                                                <td><?= $res['name'] ?></td>
