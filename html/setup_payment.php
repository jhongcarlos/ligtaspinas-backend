       ...
       <?php include('nav.php'); ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title" style="margin-top: 20px">
        ...
        <!-- CREDIT CARD FORM STARTS HERE -->
            <div class="panel panel-default credit-card-box customwidth center-block">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        ...
                        <div class="display-td" >                            
                            <img class="img-responsive pull-right" src="../plugins/images/ubank.png" height="70" width="120">
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form" action="advertisement.php">
                        <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-warning" style="float: right;" type="submit" onsubmit="alert('Success')">Confirm Payment</button>
                            </div>
                        </div>
